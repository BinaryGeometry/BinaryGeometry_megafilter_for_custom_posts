...
SearchApp.directive('systemLoader', function() {
    return {
        restrict: 'AE',
        replace: true,
...
SearchApp.directive('inputRating', function() {
    return {
...
SearchApp.directive('filterLocation', function() {
    return {
...
SearchApp.directive('filterDuration', function() {
    return {
...
SearchApp.directive('filterCost', function() {
    return {
...
SearchApp.directive('inputStar', function() {
    return {
