...
SearchApp.directive('sortByFilterBy', ['$parse', '_', 'FilterService', function($parse, _, FilterService){
    return {
        replace: true,
...
SearchApp.factory('FilterFactory', ['$http', '$q', function($http, $q){
...
SearchApp.service('FilterService', ['_', function(_) {
