...
*/
SearchApp.controller("createMembershipCtrl", function($scope, UserService, LoggedinService) {
    $scope.formData = {};
...
*/
SearchApp.directive('createMembership', ['UserService', function(UserService) {
    return {
        restrict: 'AE',
        replace: true,
        scope: {
...
*/
SearchApp.directive('createMembershipModal', ['$parse', 'UserService', function($parse, UserService){
    return {
        replace: true,
...
*/
SearchApp.controller("userLoginCtrl", function($scope, UserService, LoggedinService) {
    $scope.formData = {};
    // console.log($scope.$parent);
    $scope.$parent
...
*/
SearchApp.directive('userLogin', ['UserService', function(UserService) {
    return {
        restrict: 'AE',
        replace: true,
        scope: {
...
*/
SearchApp.directive('loginModalLauncher', ['$parse', 'UserService', function($parse, UserService){
    return {
        replace: true,
...
*/
SearchApp.controller("UserActionsCtrl", function($scope, UserService, LoggedinService) {
...
* SearchApp.controller('ListingCtrl', UserCtrl);
* SearchApp.factory('ListingService', UserService);
*/
