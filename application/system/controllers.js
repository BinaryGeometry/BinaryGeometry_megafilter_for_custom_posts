...
SearchApp.service('LoggedinService', LoggedinService);
...
SearchApp.controller('CloudCtrl', function($scope, _
    // ,UserFactory
    ,CloudFactory
    ){
...
SearchApp.directive( 'cloud', function() {
    return {
        restrict: 'AE',
        replace: true,
...
SearchApp.filter('makeLowercase', function(){
...
SearchApp.factory("CloudFactory", function($rootScope, $q, $http) {
