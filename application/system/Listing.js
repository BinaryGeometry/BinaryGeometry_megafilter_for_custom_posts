SearchApp.controller('ListingCtrl', ListingCtrl)
SearchApp.factory('ListingService', ListingService);
 ...
 * SavesCtrl
 */
SearchApp.controller('SavesCtrl', SavesCtrl);

function SavesCtrl($scope, FilterService) {
